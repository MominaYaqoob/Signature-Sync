...
class _SignaturePainter extends CustomPainter {
  _SignaturePainter(this._controller, {Color? penColor})
      : _exportPenColor = penColor,
        _penStyle = Paint(),
        super(repaint: _controller);

  final SignatureController _controller;
  final Color? _exportPenColor;
...
class SignatureController extends ValueNotifier<List<Point>> {
  ...
  /// color of a signature line (mutable so style can change without losing undo history)
  Color penColor;

  /// boldness of a signature line (mutable so style can change without losing undo history)
  double penStrokeWidth;

  /// shape of line ends (mutable so style can change without losing undo history)
  StrokeCap strokeCap;
